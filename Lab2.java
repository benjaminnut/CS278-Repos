...
public class Lab2 {
	...
	public static boolean condition5(int w, int s, int m) {
		...
		if  (condition5Point1(w,s) && condition5Point2(s,m)) 
...
//		
		if (condition1(s,r) && condition2(w,r) 
			&& condition3(m,g) && condition4(g,s) && condition5(w,s,m))
...
//		
//		
//		if (condition1(s,r) == condition2(w,r) && condition2(w,r) == condition3(m,g) 
//				&& condition3(m,g) == condition4(g,s) && condition4(g,s) == condition5(w,s,m) 
